...
public class GoldKineticEnergyCube extends KCBlock
{
	public GoldKineticEnergyCube()
	{
		super(Material.iron);
		this.setBlockName("goldKineticEnergyCube");
	...
	{
		blockIcon = iconRegister.registerIcon("KinetiCraft:goldKineticEnergyCube");
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block par5, int par6)
	{
		...
		GoldKineticEnergyCubeTileEntity te = (GoldKineticEnergyCubeTileEntity)world.getTileEntity(x, y, z);
