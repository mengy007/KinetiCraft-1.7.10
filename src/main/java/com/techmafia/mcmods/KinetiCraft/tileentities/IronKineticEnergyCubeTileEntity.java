...
public class IronKineticEnergyCubeTileEntity extends BaseKineticEnergyCubeTileEntity implements IInventory
{
	public IronKineticEnergyCubeTileEntity()
	{
		super();
		energyCores = new ItemStack[3];
	}
