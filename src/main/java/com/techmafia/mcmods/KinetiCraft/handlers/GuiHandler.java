...
import com.techmafia.mcmods.KinetiCraft.containers.KineticEnergyGeneratorContainer;
...
import com.techmafia.mcmods.KinetiCraft.gui.GuiKineticEnergyGenerator;
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world,	int x, int y, int z)
	{
		...
		else
		{
			...
			if (te != null)
			{
				...
				case 6:
					return new KineticEnergyGeneratorContainer(player.inventory, (KineticEnergyGeneratorTileEntity)te);
				}
			}
			else
			{
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		else
		{
			...
			if (te != null)
			{
				...
				case 6:
					return new GuiKineticEnergyGenerator(new KineticEnergyGeneratorContainer(player.inventory, (KineticEnergyGeneratorTileEntity)te));
				}
			}
			else
			{
